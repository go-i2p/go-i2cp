module github.com/go-i2p/go-i2cp/examples/encrypted-leaseset

go 1.24.4

replace github.com/go-i2p/go-i2cp => ../..

require (
	github.com/go-i2p/go-i2cp v0.0.0-00010101000000-000000000000
