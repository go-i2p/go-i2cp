...
func TestMessageStatusConstants(t *testing.T) {
	tests := []struct {
		...
		{"Bad Options", MSG_STATUS_BAD_OPTIONS, 12},
		{"Overflow Failure", MSG_STATUS_OVERFLOW_FAILURE, 13},
		{"Message Expired", MSG_STATUS_MESSAGE_EXPIRED, 14},
		{"Bad Local LeaseSet", MSG_STATUS_BAD_LOCAL_LEASESET, 15},
		{"No Local Tunnels", MSG_STATUS_NO_LOCAL_TUNNELS, 16},
		{"Unsupported Encryption", MSG_STATUS_UNSUPPORTED_ENCRYPTION, 17},
		{"Bad Destination", MSG_STATUS_BAD_DESTINATION, 18},
		{"Bad LeaseSet", MSG_STATUS_BAD_LEASESET, 19},
		{"Expired LeaseSet", MSG_STATUS_EXPIRED_LEASESET, 20},
		{"No LeaseSet", MSG_STATUS_NO_LEASESET, 21},
